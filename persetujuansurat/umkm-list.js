function loadTable() {
    ...
    xhttp.open("GET", "https://tupaii.my.id/api/info-umkms?populate=*");
    ...
    xhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        ...
        for (let object of objects.data) { 
          ...
          if(attributes['foto_umkm']['data'] == null){
            trHTML += '<td> <img src="images/logo.png" alt="Test Image" style=" height: 60px;"></img></td>';
          }else{
            trHTML += '<td> <img src="https://tupaii.my.id'+attributes['foto_umkm']['data'][0]['attributes']['formats']['small']['url'] +'" alt="Test Image" style=" height: 60px;"></img></td>';
